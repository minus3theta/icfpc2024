...
#[rstest]
#[case::negation("U- I$", BigInt::from(-3).into())]
#[case::not("U! T", false.into())]
#[case::stoi("U# S4%34",  BigInt::from(15818151).into())]
#[case::itos("U$ I4%34", "test".to_owned().into())]
#[case::add("B+ I# I$", BigInt::from(5).into())]
#[case::sub("B- I$ I#", BigInt::from(1).into())]
#[case::mul("B* I$ I#", BigInt::from(6).into())]
#[case::div("B/ U- I( I#", BigInt::from(-3).into())]
#[case::modulo("B% U- I( I#", BigInt::from(-1).into())]
...
#[case::eval_ex(r#"B$ L# B$ L" B+ v" v" B* I$ I# v8"#, BigInt::from(12).into())]
#[case::limits_ex(r#"B$ B$ L" B$ L# B$ v" B$ v# v# L# B$ v" B$ v# v# L" L# ? B= v# I! I" B$ L$ B+ B$ v" v$ B$ v" v$ B- v# I" I%"#, BigInt::from(16).into())]
