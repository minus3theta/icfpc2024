...
export function vis(a: number, b: number, c: number, d: number, e: number, f: number, g: number): number;
export function get_max_turn(a: number, b: number, c: number, d: number, e: number, f: number): number;
