...
* @returns {string}
*/
export function gen(seed, game_type) {
    let deferred2_0;
    let deferred2_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(game_type, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.gen(retptr, seed, ptr0, len0);
...
* @returns {Ret}
*/
export function vis(_input, _output, turn, game_type) {
    ...
    const ptr2 = passStringToWasm0(game_type, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len2 = WASM_VECTOR_LEN;
    const ret = wasm.vis(ptr0, len0, ptr1, len1, turn, ptr2, len2);
...
* @returns {number}
*/
export function get_max_turn(_input, _output, game_type) {
    const ptr0 = passStringToWasm0(_input, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(_output, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ptr2 = passStringToWasm0(game_type, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len2 = WASM_VECTOR_LEN;
    const ret = wasm.get_max_turn(ptr0, len0, ptr1, len1, ptr2, len2);
    return ret >>> 0;
}
